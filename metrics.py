#List of metrics:
#CPU: number_of_cores, cpu_usage_%
#Memory: memory_used_%, memory_used_gb, total_memory_gb, free_memory_gb
#Disk: disk_used_gb, disk_used_%, disk_total_gb, disk_free_gb
#OS: distro_name, disttro_pretty_name, distro, os_name, os_verison, kernal_version, os_architecture
import psutil
import platform
import shutil
